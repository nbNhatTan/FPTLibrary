    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (checkDuplicate) {
                ...
                accountError.setRoleIDError("RoleID must be in [0,1]");
                checkValidation = false;
            }if (!Pattern.matches("\\d{5-20}[-|@]\\d{5-20}", email)) {
            ...
            if (checkValidation) {
                AccountDTO account = new  AccountDTO(accountID, fullName, password, roleID, email, address, phone, true);
